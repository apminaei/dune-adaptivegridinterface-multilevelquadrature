...
/* Define to 1 if you have module dune-howto-adaptive-grid-multilevel-quad available */
#define HAVE_DUNE_HOWTO_ADAPTIVE_GRID_MULTILEVEL_QUAD 1
...
/* begin dune-howto-adaptive-grid-multilevel-quad
...
/* begin private */
/* Name of package */
#define PACKAGE "dune-howto-adaptive-grid-multilevel-quad"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "math.amir@gmail.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dune-howto-adaptive-grid-multilevel-quad"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dune-howto-adaptive-grid-multilevel-quad 1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dune-howto-adaptive-grid-multilevel-quad"
...
/* Define to the version of dune-howto-adaptive-grid-multilevel-quad */
#define DUNE_HOWTO_ADAPTIVE_GRID_MULTILEVEL_QUAD_VERSION "1.0"

/* Define to the major version of dune-howto-adaptive-grid-multilevel-quad */
#define DUNE_HOWTO_ADAPTIVE_GRID_MULTILEVEL_QUAD_VERSION_MAJOR 1

/* Define to the minor version of dune-howto-adaptive-grid-multilevel-quad */
#define DUNE_HOWTO_ADAPTIVE_GRID_MULTILEVEL_QUAD_VERSION_MINOR 0

/* Define to the revision of dune-howto-adaptive-grid-multilevel-quad */
#define DUNE_HOWTO_ADAPTIVE_GRID_MULTILEVEL_QUAD_VERSION_REVISION 0

/* end dune-howto-adaptive-grid-multilevel-quad
